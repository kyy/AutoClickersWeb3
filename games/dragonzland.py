...
TELEGRAM_URL = "https://web.telegram.org/k/#@dragonz_land_bot"
...
async def run(playwright: Playwright):
    ...
    try:
        await page.get_by_role("button").filter(has_text="got it").tap()
    except:
        pass
    ...
    while True:
        ...
        if elapsed_time > duration:
            await browser.close()
        energy_current = await page.locator('//*[@id="view"]/div[3]/dl/dd').text_content()
