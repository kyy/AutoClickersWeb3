...
TELEGRAM_URL = "https://web.telegram.org/k/#@dormint_bot"
...
async def run(playwright: Playwright):
    ...
    try:
        await page.get_by_role("button", name="Continue").tap(timeout=2500)
    except:
        pass
    ...
    time.sleep(8)
    try:
        await page.get_by_text('Start sleeping').tap(timeout=2500)
    except:
        pass
    time.sleep(2)
    await browser.close()
